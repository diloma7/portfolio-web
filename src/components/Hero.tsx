...
export default function Hero() {
  return (
    <section
      className="relative min-h-[calc(100svh-4rem)] flex items-start pt-8 md:pt-12"
      aria-label="Hero"
    >
      <BackgroundFX />
      ...
      <div className="container max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          >
            I craft accessible, performant web apps with TypeScript, React, and
            delightful UX.
          </motion.p>
        ...
        <div className={cn("hidden md:block justify-self-end")}>
          <div className="rounded-2xl  p-3 shadow-card bg-white/5 dark:bg-neutral-900/30 backdrop-blur">
            <ThreeBlob
              className="h-[480px] w-[520px] md:h-[420px] md:w-[460px]"
              dark
              imageSrc="/earth.jpg" // remove this prop to use the color material instead
            />
          </div>
        </div>
      </div>
